...
export default function AliasesPage() {
  ...
  const onSubmit = (values: AliasForm) => {
    // Los destinos se separan por coma o salto de línea
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Redirecciones y distribuciones ({data?.total ?? 0} en total)
          </p>
        </div>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem
                            onClick={() =>
                              toggleMutation.mutate({ id: alias.id, active: !alias.active })
                            }
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Crea una redirección de correo hacia uno o más destinos.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Separa varios destinos con comas o saltos de línea.
              </p>
              {errors.destinations && (
